...
#define TIM6_CR1 (TIM6_BASE + 0x00UL)
#define TIM6_CR2 (TIM6_BASE + 0x04UL)
#define TIM6_DIER (TIM6_BASE + 0x0CUL)
#define TIM6_SR (TIM6_BASE + 0x10UL)
#define TIM6_EGR (TIM6_BASE + 0x14UL)
#define TIM6_CNT (TIM6_BASE + 0x24UL)
#define TIM6_PSC (TIM6_BASE + 0x28UL)
#define TIM6_ARR (TIM6_BASE + 0x2CUL)
